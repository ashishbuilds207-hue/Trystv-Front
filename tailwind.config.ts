    ...
    theme: {
        ...
        colors: {
            ...
            tryst: {
                bg: 'var(--tryst-bg)',
                'bg-2': 'var(--tryst-bg-2)',
                'bg-3': 'var(--tryst-surface)',
                card: 'var(--tryst-card)',
                'card-2': 'var(--tryst-card-2)',
                elevated: 'var(--tryst-elevated)',
                border: 'var(--tryst-border)',
                'border-2': 'var(--tryst-border-2)',
                muted: 'var(--tryst-muted)',
                'muted-2': 'var(--tryst-muted-2)',
                text: 'var(--tryst-text)',
                'text-soft': 'var(--tryst-text-soft)',
            },
        ...
        extend: {
            ...
            backgroundImage: {
                'tryst-gradient': 'linear-gradient(135deg, var(--tryst-bg) 0%, var(--tryst-bg-2) 50%, var(--tryst-bg) 100%)',
                'crimson-gradient': 'linear-gradient(135deg, #C0392B 0%, #922B21 100%)',
                'gold-gradient': 'linear-gradient(135deg, #D4AF37 0%, #B8860B 100%)',
                'hero-radial': 'var(--tryst-hero-radial)',
                'card-gradient': 'linear-gradient(180deg, transparent 0%, color-mix(in srgb, var(--tryst-bg) 80%, transparent) 60%, var(--tryst-bg) 100%)',
