        ...
        <div className="you-card p-5 mb-5">
            <div className="flex items-center gap-5">
                <div className="relative w-20 h-20 flex-shrink-0">
                    <svg className="w-20 h-20 -rotate-90" viewBox="0 0 80 80">
                        <circle cx="40" cy="40" r="36" fill="none" stroke="var(--tryst-border)" strokeWidth="6" />
                    ...
                    <div className="absolute inset-0 flex items-center justify-center">
                        <span className="font-playfair text-xl font-bold text-tryst-text">{percent}%</span>
                    </div>
                </div>
                <div className="flex-1">
                    <p className="font-playfair text-lg text-tryst-text">Profile strength</p>
                    <p className="text-tryst-muted text-xs mt-0.5">
                        {data?.completion?.filled ?? 0}/{data?.completion?.total ?? 12} fields complete
                    </p>
                    {percent < 100 && missing.length > 0 && (
                        <p className="text-tryst-muted text-[10px] mt-1.5">
            ...
            {dailyLikes && !dailyLikes.isGold && (
                <div className="mt-4 pt-4 border-t border-tryst-border flex items-center justify-between">
                    <div>
                        <p className="text-tryst-text-soft text-sm font-medium">Daily likes</p>
                        <p className="text-tryst-muted text-xs">{dailyLikes.remaining} of {dailyLikes.limit} remaining today</p>
                    </div>
